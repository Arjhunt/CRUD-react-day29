...
function Useredit() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async values => {
            try {
                await fetch(`https://61c3dc4af1af4a0017d990ce.mockapi.io/users/${params.id}`, {
                    method: "PUT",
    ...
    useEffect(async () => {
        try {
            let userdata = await fetch(`https://61c3dc4af1af4a0017d990ce.mockapi.io/users/${params.id}`);
